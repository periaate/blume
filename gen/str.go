...
func Contains[S ~string](args ...S) T.Predicate[S] {
...
func HasPrefix[S ~string](args ...S) T.Predicate[S] {
	return func(str S) bool {
...
func HasSuffix[S ~string](args ...S) T.Predicate[S] {
	return func(str S) bool {
		l := Lim[S](len(str))(args)
		for _, arg := range l {
...
func ReplacePrefix[S ~string](pats ...S) T.Transformer[S] {
	return func(str S) S {
		if len(pats)%2 != 0 {
			return str
		}
...
func ReplaceSuffix[S ~string](pats ...S) T.Transformer[S] {
	return func(str S) S {
		if len(pats)%2 != 0 {
			return str
		}
...
func Replace[S ~string](pats ...S) T.Transformer[S] {
	return func(str S) S {
		if len(pats)%2 != 0 {
			return str
		}
...
func ReplaceRegex[S ~string](pat string, rep string) T.Transformer[S] {
...
func Shift[S ~string](count int) T.Transformer[S] {
...
func Pop[S ~string](count int) T.Transformer[S] {
	return func(a S) (res S) {
		if len(a) < count {
			return
		}
