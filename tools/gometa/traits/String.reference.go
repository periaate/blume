...
func (s __String__) Or(Default string) __String__ {
	if s == "" { return __String__(Default) }
	return s
}
func (s __String__) Len() int       { return len(string(s)) }
func (s __String__) String() string { return string(s) }

// func (s __String__) ToInt() Result[int]         { return gen.ToInt(string(s)) }
// func (s __String__) ToInt8() Result[int8]       { return gen.ToInt8(string(s)) }
// func (s __String__) ToInt16() Result[int16]     { return gen.ToInt16(string(s)) }
// func (s __String__) ToInt32() Result[int32]     { return gen.ToInt32(string(s)) }
// func (s __String__) ToInt64() Result[int64]     { return gen.ToInt64(string(s)) }
// func (s __String__) ToUint() Result[uint]       { return gen.ToUint(string(s)) }
// func (s __String__) ToUint8() Result[uint8]     { return gen.ToUint8(string(s)) }
// func (s __String__) ToUint16() Result[uint16]   { return gen.ToUint16(string(s)) }
// func (s __String__) ToUint32() Result[uint32]   { return gen.ToUint32(string(s)) }
// func (s __String__) ToUint64() Result[uint64]   { return gen.ToUint64(string(s)) }
// func (s __String__) ToFloat32() Result[float32] { return gen.ToFloat32(string(s)) }
// func (s __String__) ToFloat64() Result[float64] { return gen.ToFloat64(string(s)) }
//
...
// func (s __String__) LightMagenta() __String__ { return gen.Colorize(gen.LightMagenta, s) }
