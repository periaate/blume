The {{ .Module }} server starts two endpoints, one inward enpoint, used to generate links to authenticate users, the other to validate said sessions. For example, starting `fwauth` with the following command:
```
fwauth :8900 :8950
```
